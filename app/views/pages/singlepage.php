...
<div class="max-w-screen-xl mx-auto">
    ...
    <main class="mt-10">
      ...
      <div class="mb-4 md:mb-0 w-full max-w-screen-md mx-auto relative" style="height: 24em;">
        ...
        <img src="../public/img/<?=basename($data[7])?>" />
        <div class="p-4 absolute bottom-0 left-0 z-20">
          <a href="#"
            class="px-4 py-1 bg-black text-gray-200 inline-flex items-center justify-center mb-2"><?=$data[14]?></a>
          ...
          <div class="flex mt-3">
            ...
            <div>
              <p class="font-semibold text-gray-200 text-sm"> <?=$data[9]?> </p>
              <p class="font-semibold text-gray-400 text-xs"> <?=$data[3]?> </p>
            </div>
          </div>
        </div>
      </div>
